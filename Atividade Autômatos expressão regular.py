...
while True:
    ...
    resultado = validarNome(tentativa_nome)
    if not resultado:
...
while True:
    ...
    resultado = validarEmail(tentativa_email)
    if not resultado:
...
while True:
    ...
    resultado = validarSenha(tentativa_senha)
    if not resultado:
...
while True:
    ...
    resultado = validarCPF(tentativa_cpf)
    if not resultado:
...
while True:
    ...
    resultado = validarTelefone(tentativa_telefone)
    if not resultado:
...
while True:
    ...
    resultado = validarData(tentativa_data)
    if not resultado:
...
while True:
    ...
    resultado = validarReal(tentativa_real)
    if not resultado:
